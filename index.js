...
app.post("/createTicket" , async(req,res)=>{
    const {cId , description , desc , quant , unit , pName, id} = req.body
    try{
        const payload = {
            companyID : cId,
            ...
            queueID: 5,
            description: `Payment for Quote Number ${id} , The stripe customer id is ${description} the company Name is ${desc} , Product Name is ${pName} ,qunantity of product is ${quant} & unit price is ${unit}`
          };
